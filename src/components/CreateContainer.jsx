...
import {MdFastfood ,MdCloudDownload , MdDelete, MdFoodBank, MdAttachMoney} from 'react-icons/md'
import { categories } from '../utils/data';
import Loader from './Loader';
import { deleteObject, ref } from 'firebase/storage';
import {getDownloadURL,uploadBytesResumable} from 'firebase/storage'
import {storage} from "../firebase.config"
import { saveItem } from '../utils/FiredbaseFunction';
...
const CreateContainer = () => {
  ...
  const deleteImage =() => {
    setIsLoading(true)
    const deleteRefs = ref(storage,imageAsset)
  ...
  return (
    <div className='w-full h-min p-4 flex items-center justify-center'>
      ...
      rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2 '>
            <MdFastfood className='text-xl to-gray-700 ' />
            <input
            type="text"
            required 
            value={title} 
        ...
        <div className='w-full'>
          ...
          >
            ...
            {categories && categories.map(item => (
              ...
              outline-none capitalize bg-white text-gray-800"
        ...
        <div className='group h-[300px]  flex justify-center items-center flex-col border-2
        ...
        <div className='w-full flex items-center justify-center '>
                <button type='button' className='ml-0 md:al-auto w-full md:w-auto
